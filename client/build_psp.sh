...
psp-gcc $gcc_prx_args psp_main.o log_impl_psp.o sock_impl_psp.o mutex_impl_psp.o delay_impl_psp.o postoffice.o ATPRO.o exports.o -o postoffice.elf $gcc_prx_libs
