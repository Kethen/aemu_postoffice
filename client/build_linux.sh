...
g++ -O0 test.o postoffice.o sock_impl_linux.o mutex_impl_cpp.o delay_impl_cpp.o -o test.out
g++ -fPIC -shared postoffice.o sock_impl_linux.o mutex_impl_cpp.o delay_impl_cpp.o -o libaemu_postoffice_client.so
