...
$CPPC $BUILD_FLAGS adhocctl.o sock_impl_linux.o log_impl_stdc.o test.o -o test.out
$CPPC $BUILD_FLAGS -shared adhocctl.o sock_impl_linux.o log_impl_stdc.o -o libadhocctl.so
