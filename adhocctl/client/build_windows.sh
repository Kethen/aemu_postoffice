...
$CPPC $BUILD_FLAGS -static adhocctl.o adhocctl_mem.o sock_impl_windows.o log_impl_stdc.o test.o -lws2_32 -o test.exe
$CPPC $BUILD_FLAGS -shared -static adhocctl.o adhocctl_mem.o sock_impl_windows.o log_impl_stdc.o -lws2_32 -o libadhocctl.dll
